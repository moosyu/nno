...
public class AttributesRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> SWEEP = ATTRIBUTES.register("sweep", () -> new RangedAttribute("attribute.name.nno.sweep", 1.0D, 0.0D, 1024.0D).setSyncable(true));
}